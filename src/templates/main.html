    ...
    <main class="container container-fluid">
      <div class="row mt-3">
        <div class="col-6">
          <div class="d-flex flex-column h-100">
            ...
            <button
              type="button"
              class="btn btn-dark align-self-start py-2 w-50 mt-auto border-r"
            >
              Explore More
            </button>
          </div>
        ...
        <div class="col-6">
          <img src="../assets/imgs/main_pic.png" alt="" class="img-fluid" />
        </div>
      </div>
      <!-- list -->
      <div class="row mt-5">
      ...
      <div class="row mt-5 banner position-relative overflow-hidden">
        ...
        <div class="col-7 h-100 d-flex align-items-center z-1">
          <div class="h-75 ms-5">
            <img
              src="../assets/imgs/banner_phone.png"
              alt="Banner"
          ...
          <div class="row d-flex align-items-center">
            ...
            <div class="col-2">
              <div class="mx-auto w-75">
                <img
                  src="../assets/imgs/apple_brand.png"
            ...
            <div class="col-2">
              <div class="mx-auto w-75">
                <img
                  src="../assets/imgs/sony_brand.png"
                  class="img-fluid object-fit-contain"
                  alt="sony"
                />
              </div>
            ...
            <div class="col-2">
              <div class="mx-auto w-75">
                <img
                  src="../assets/imgs/samsung_brand.png"
                  class="img-fluid object-fit-contain"
                  alt="samsung"
                />
              </div>
            ...
            <div class="col-2">
              <div class="mx-auto w-75">
                <img
                  src="../assets/imgs/canon_brand.png"
                  class="img-fluid object-fit-contain"
                  alt="canon"
                />
              </div>
            ...
            <div class="col-2">
              <div class="mx-auto w-75">
                <img
                  src="../assets/imgs/huawei_brand.png"
                  class="img-fluid object-fit-contain"
                  alt="huawei"
                />
              </div>
            ...
            <div class="col-2">
              <div class="mx-auto w-75">
                <img
                  src="../assets/imgs/lenovo_brand.png"
                  class="img-fluid object-fit-contain"
                  alt="lenovo"
                />
              </div>
