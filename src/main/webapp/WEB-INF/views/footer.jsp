          ...
          <ul class="nav flex-column">
            <li class="nav-item mb-2">
              <a href="#" class="nav-link p-0 footer_link text-nowrap"
                ><img src="../assets/icon/adress_icon_footer.svg" alt="" /> 123
                Main Street, Anytown,USA</a
              >
            </li>
            <li class="nav-item mb-2">
              <a href="#" class="nav-link p-0 footer_link text-nowrap"
                ><img src="../assets/icon/phone_icon_footer.svg" alt="" /> +1
                (555) 123-4567</a
              >
            </li>
            <li class="nav-item mb-2">
              <a href="#" class="nav-link p-0 footer_link text-nowrap"
                ><img src="../assets/icon/mail_icon_footer.svg" alt="" />
        ...
        >
          <form>
            ...
            >
              ...
              >
              <img
                src="../assets/icon/user_icon_footer.svg"
                alt=""
                class="p-1"
              />
              <input
